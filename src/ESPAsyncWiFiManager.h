...
const char HTTP_PORTAL_OPTIONS[] PROGMEM = "<form action=\"/wifi\" method=\"get\"><button>Настроить WiFi</button></form><br/><form action=\"/r\" method=\"post\"><button>Reset</button></form>";
...
const char HTTP_SAVED[] PROGMEM = "<div>Сохранено!<br />Пытаемся подключиться с указанными реквизитами.<br />При удачном подключении индикатор устройства будет вспыхивать сериями по 2 раза. В противном случае Вам нужно повторить процедуру настройки заново</div>";
